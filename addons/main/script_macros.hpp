...
#undef PREP
    ...
    #define PREP_RECOMPILE_START    if (isNil "ttt_userconfig_fnc_recompile") then {ttt_userconfig_recompiles = []; ttt_userconfig_fnc_recompile = {{call _x} forEach ttt_userconfig_recompiles;}}; private _recomp = {
    #define PREP_RECOMPILE_END      }; call _recomp; ttt_userconfig_recompiles pushBack _recomp;
#else
