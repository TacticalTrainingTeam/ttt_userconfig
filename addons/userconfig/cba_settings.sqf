...
forec force ace_casings_maxCasings = 250;
...
// ACE Cook off
force ace_cookoff_ammoCookoffDuration = 0.01;
...
// ACE Explosives
force ace_explosives_customTimerDefault = 90;
...
force force ace_cargo_checkSizeInteraction = false;
...
force ace_medical_treatment_litterCleanupDelay = 900;
...
force ace_medical_treatment_medicSplint = 1;
...
ace_viewdistance_viewDistanceAirVehicle = 6000;
...
force grad_trenches_functions_hitDecayMultiplier =0.8;
...
force lambs_danger_panicChance = 0.201231;
...
force force tsp_cba_breach_shock = 180;
...
//DUI - Squad Radar
force force diwako_dui_linecompass_DrawBearing = 1;
...
zen_faction_filter_1_rsrVehicles = true;
...
Achilles_var_UK3CB_APD_B = true;
Achilles_var_UK3CB_APD_I = true;
Achilles_var_UK3CB_APD_O = true;
...
Achilles_var_UK3CB_BAF_Faction_Airforce_Woodland_CW = true;
...
Achilles_var_UK3CB_BAF_Faction_Army_Woodland_CW = true;
...
Achilles_var_UK3CB_BAF_Faction_Navy_Woodland_CW = true;
...
Achilles_var_UK3CB_FIA_B = true;
Achilles_var_UK3CB_FIA_I = true;
Achilles_var_UK3CB_FIA_O = true;
Achilles_var_UK3CB_GAF_B = true;
Achilles_var_UK3CB_GAF_I = true;
Achilles_var_UK3CB_GAF_O = true;
Achilles_var_UK3CB_ION_B_Desert = true;
Achilles_var_UK3CB_ION_B_Urban = true;
Achilles_var_UK3CB_ION_B_Winter = true;
Achilles_var_UK3CB_ION_B_Woodland = true;
Achilles_var_UK3CB_ION_I_Desert = true;
Achilles_var_UK3CB_ION_I_Urban = true;
Achilles_var_UK3CB_ION_I_Winter = true;
Achilles_var_UK3CB_ION_I_Woodland = true;
Achilles_var_UK3CB_ION_O_Desert = true;
Achilles_var_UK3CB_ION_O_Urban = true;
Achilles_var_UK3CB_ION_O_Winter = true;
Achilles_var_UK3CB_ION_O_Woodland = true;
Achilles_var_UK3CB_KDF_B = true;
Achilles_var_UK3CB_KDF_I = true;
Achilles_var_UK3CB_KDF_O = true;
Achilles_var_UK3CB_KRG_B = true;
Achilles_var_UK3CB_KRG_I = true;
Achilles_var_UK3CB_KRG_O = true;
Achilles_var_UK3CB_LDF_B = true;
Achilles_var_UK3CB_LDF_I = true;
Achilles_var_UK3CB_LDF_O = true;
Achilles_var_UK3CB_LFR_B = true;
Achilles_var_UK3CB_LFR_I = true;
Achilles_var_UK3CB_LFR_O = true;
Achilles_var_UK3CB_LNM_B = true;
Achilles_var_UK3CB_LNM_I = true;
Achilles_var_UK3CB_LNM_O = true;
Achilles_var_UK3CB_LSM_B = true;
Achilles_var_UK3CB_LSM_I = true;
Achilles_var_UK3CB_LSM_O = true;
Achilles_var_UK3CB_MDF_B = true;
Achilles_var_UK3CB_MDF_I = true;
Achilles_var_UK3CB_MDF_O = true;
Achilles_var_UK3CB_MEE_I = true;
Achilles_var_UK3CB_MEE_O = true;
Achilles_var_UK3CB_MEI_B = true;
Achilles_var_UK3CB_MEI_I = true;
Achilles_var_UK3CB_MEI_O = true;
